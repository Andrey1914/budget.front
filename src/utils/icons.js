...
export const login = <i class="fa fa-sign-in" aria-hidden="true"></i>;
export const car = <i class="fa fa-car" aria-hidden="true"></i>;
...
export const euro = <i class="fa fa-eur" aria-hidden="true"></i>;
...
export const housing = <i class="fa fa-home" aria-hidden="true"></i>;
export const communication = <i class="fa fa-mobile" aria-hidden="true"></i>;
