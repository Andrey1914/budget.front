...
export const login = <i className="fa fa-sign-in" aria-hidden="true"></i>;
export const car = <i className="fa fa-car" aria-hidden="true"></i>;
...
export const dollar = <i className="fa-solid fa-money-bill-1"></i>;
export const euro = <i className="fa fa-eur" aria-hidden="true"></i>;
...
export const travel = <i className="fa fa-plane" aria-hidden="true"></i>;
export const housing = <i className="fa fa-home" aria-hidden="true"></i>;
